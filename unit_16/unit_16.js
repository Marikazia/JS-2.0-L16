...
function f3() {
    let d3 = document.getElementsByClassName('out-3')
    console.log(d3)
    for (let item of d3) {
        item.textContent = 3;
    }   
...
function f4() {
    let d4 = document.querySelectorAll('.out-4')
...
function f15() {
    out = '';
    let t = document.querySelectorAll('.out-15');
    for (let item of t) {
        console.log(item);
        item.textContent = 15;
    }
    // document.querySelector('.out-14').textContent = 15;
}
